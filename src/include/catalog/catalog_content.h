...
public:
    ...
    inline bool containsNodeTable() const { return containTable(common::TableType::NODE); }
    inline bool containsRelTable() const { return containTable(common::TableType::REL); }
    inline bool containsRdfGraph() const { return containTable(common::TableType::RDF); }
...
private:
    ...
    bool containTable(common::TableType tableType) const;
